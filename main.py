...
if(sim_choice != 10):
    if sim_choice == 1:
        ...
        # Call the function to handle option 1
        # You can place the code for option 1 here or call a separate function
        ...
        # prompt user if they wish to select another simulation to run or exit the program
    elif sim_choice == 2:
...
#sim_choice = input().lower()
#while sim_choice not in ['yes', 'y', 'no', 'n']:
#    print("Please enter 'yes' or 'no'.")
#    sim_choice = input().lower()
#
#if sim_choice in ['yes', 'y']:
#    integrand_functions = {
#        '1': ("x^2", lambda x: x ** 2),
#        '2': ("sin(x)", math.sin),
