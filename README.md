...
│
├── confidence.py
├── export_results.py  # exports results of each simulation as json and csv
│
...
│
├── visualizationInt.py     # these files visualize the results of each simulation using matplotlib
